...
abstract class ExperienceData {
  static const List<ExperienceModel> all = [
    ...
    ExperienceModel(
      ...
      highlights: [
        'Built Flutter fintech platform from greenfield to production',
        ...
        'Architected real-time event-driven customer–agent chat system',
    ...
    ExperienceModel(
      ...
      highlights: [
        'Delivered SmartSend Finance, ZojaPay & AIICO Invest to production',
    ...
    ExperienceModel(
      ...
      highlights: [
        ...
        'Integrated DataDog & analytics — increased user engagement by 20%',
